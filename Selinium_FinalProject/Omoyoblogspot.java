package Selinium_FinalProject;
	...
	public class Omoyoblogspot 
	{
		public static void main(String[] args) throws InterruptedException 
		{
			...
			driver.findElement(By.xpath("//*[@id=\"HTML42\"]/div[1]/form/input[1]")).sendKeys("Vinod"); 
			
			//Enter the password of simple login page
			driver.findElement(By.xpath("//*[@id=\"HTML42\"]/div[1]/form/input[2]")).sendKeys("Vinod@123");  
